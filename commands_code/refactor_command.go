...
func (c *RefactorCommand) PreparePrompt(cliContext *cli.Context) (string, error) {
	...
	userPrompt := "Please refactor it using the best practices of the language that is used. Ideally final version should be as readable as possible. You can refactor any way you want as long as public APIs are no changed. Feel free to extract anything that is needed to a helper function/methods entities. Your final output should be full content of the file end-to-end without any text before/after, I will use your output and override my original file."
